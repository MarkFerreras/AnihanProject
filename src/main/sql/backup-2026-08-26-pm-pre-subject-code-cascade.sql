...
INSERT INTO `subjects` VALUES ('BPP-101','Bread Making Fundamentals',2,'CORE',3,NULL),('BPP-102','Pastry Arts',2,'CORE',4,NULL),('COOK-101','Introduction to Cookery',1,'CORE',3,NULL),('COOK-102','Food Safety and Sanitation',1,'CORE',3,NULL),('COOK-103','Prepare Hot Meals',1,'CORE',5,NULL),('COOK-104','Prepare Cold Meals',1,'CORE',4,NULL);
...
INSERT INTO `system_logs` VALUES (1,2,'registrar','ROLE_REGISTRAR','User logged in','0:0:0:0:0:0:0:1','2026-08-26 11:45:28'),(2,2,'registrar','ROLE_REGISTRAR','User logged in','0:0:0:0:0:0:0:1','2026-08-26 17:48:21'),(3,2,'registrar','ROLE_REGISTRAR','User logged in','127.0.0.1','2026-08-26 20:02:55');
...
INSERT INTO `users` VALUES (1,'admin','$2a$10$MN4FaQaQ0DaFVFHVHQ8WceI4VPzaXmZqOhcF1fai.Rr7Jbude9kz6','Dela Cruz','Juan','Santos','1995-06-15',30,'juan.delacruz@example.com','ROLE_ADMIN',1,NULL),(2,'registrar','$2a$10$MN4FaQaQ0DaFVFHVHQ8WceI4VPzaXmZqOhcF1fai.Rr7Jbude9kz6','Reyes','Maria','Garcia','1990-03-22',36,'maria.reyes@example.com','ROLE_REGISTRAR',1,NULL),(3,'trainer','$2a$10$MN4FaQaQ0DaFVFHVHQ8WceI4VPzaXmZqOhcF1fai.Rr7Jbude9kz6','Santos','Carlos','Mendoza','1988-11-08',37,'carlos.santos@example.com','ROLE_TRAINER',1,NULL);
...
-- Dump completed on 2026-08-26 12:12:07
