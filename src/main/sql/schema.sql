...
-- Updated: 2026-08-27 (removed subjects.trainer_id — trainer assignment
--                       is class-level only, via classes.trainer_id)
...
--
-- Existing databases that predate 2026-08-27 should also run
-- src/main/sql/migrations/2026-08-27-remove-subjects-trainer.sql to
-- drop subjects.trainer_id and its FK — trainer assignment is now
-- class-level only.
-- ============================================================
...
-- ============================================================
-- TABLE: subjects
-- Trainer assignment is class-level only (see classes.trainer_id) —
-- a subject has no trainer of its own; it can be taught by different
-- trainers across different classes (sections/semesters).
-- ============================================================
