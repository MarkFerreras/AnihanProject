...
INSERT INTO `subjects` VALUES ('BPP-101','Bread Making Fundamentals',2,'CORE',3,3),('BPP-102','Pastry Arts',2,'CORE',4,NULL),('COOK-101','Introduction to Cookery',1,'CORE',3,NULL),('COOK-102','Food Safety and Sanitation',1,'CORE',3,NULL),('COOK-103','Prepare Hot Meals',1,'CORE',5,NULL),('COOK-104','Prepare Cold Meals',1,'CORE',4,NULL);
...
-- Dump completed on 2026-08-26 17:07:50
